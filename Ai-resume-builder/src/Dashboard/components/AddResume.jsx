  ...
  return (
    <>
      <button
        ...
        className="app-tilt-card group relative flex h-full min-h-[220px] w-full flex-col items-center justify-center overflow-hidden rounded-2xl border border-dashed border-teal-300/80 bg-gradient-to-br from-teal-50 via-[var(--app-surface)] to-[var(--app-soft)] p-5 text-left cursor-pointer dark:border-teal-700/60 dark:from-teal-950/40 sm:min-h-[280px] sm:p-6"
