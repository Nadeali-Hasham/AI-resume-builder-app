...
const ResumeCardsItem = ({ resume }) => {
  ...
  return (
    ...
    <Link to={`/dashboard/resume/${resumeData.resumeId}/edit`}>
        <div className="border p-14 bg-secondary flex items-center justify-center h-72 border-primary rounded-lg hover:scale-105 transition-all duration-200 hover:shadow-md shadow-primary">
            <Notebook />
        </div>
